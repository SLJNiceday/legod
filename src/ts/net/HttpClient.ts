...
export default class HttpClient implements IHttp {
    ...
    //网吧版api*******************************start
    public static NETBAR_AUTH_LOGIN = "/bar/auth/login"; //登录
    public static NETBAR_AUTH_REGISTER = "/bar/auth/register"; //注册
    public static NETBAR_ACCOUNT_INFO = '/bar/account/info';//获取用户信息
    public static NETBAR_ACCOUNT_EDIT = '/bar/account/edit';//修改用户信息

    public static NETBAR_ACCOUNT_PACKAGE = '/bar/account/package';//获取当前套餐
    public static NETBAR_ACCOUNT_PACKAGE_LIST = '/bar/account/package/list';//获取可购买套餐
    public static NETBAR_ACCOUNT_PACKAGE_BUY = '/bar/account/package/buy';//获取可购买套餐
    public static NETBAR_INVOICE_STATE = '/bar/user/invoice/state';//获取订单支付状态
    public static NETBAR_INVOICE_LIST = '/bar/user/invoice/list';//获取订单列表
