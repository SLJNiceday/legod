...
export default class LocalStorageUtil {
    ...
    public static STORAGES_BIZTOKEN = "netbar_biztoken";
    ...
    public static STORAGES_REG_STEP= "regstep";//注册到第几步
    public static BUSINESS_TYPE= "business_type";//商户类型
    public static STORAGES_REG_TOKEN= "regToken";//注册用到的token
    public static STORAGES_SUB_USERID= "subuserid";//子账户id
