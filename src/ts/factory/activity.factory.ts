export default class ActivityFactory {
    ...
    public banner_logo:string=''//顶部bannerd的logo
    ...
    public getActivityModel(type: string,id: number){
        switch(id){
            ...
            case 216:
                ...
                break;
            case 220:
                this.endtime = '2019-08-31 15:30:00';
                this.choujiang_type = 2;
                this.cj_success_type = true;
                this.banner_bg_top = './images/activity_dota2/banner01.jpg';
                this.banner_bg_bottom = './images/activity_dota2/banner02.jpg';
                this.banner_bg_foot= './images/activity_dota2/banner03.jpg';
                this.banner_logo = './images/activity_dota2/logo.png';
                this.banner_title = './images/activity_dota2/font_main.png';
                if(type != 'pc'){
                    this.banner_bg_top = '/images/activity_dota2/banner01.jpg';
                    this.banner_title = '/images/activity_dota2/font_main.png';
                    this.banner_bg_bottom = '/images/activity_dota2/banner02.jpg';
                    this.dialog_notice_bg="/images/activity_dota2/tips01.png"
                    this.present_list_bg = '/images/activity_dota2/bg_box.png';
                    this.prize_active_img = [
                        '/images/activity_dota2/light.png'
                    ];
                }
                break;
        }
