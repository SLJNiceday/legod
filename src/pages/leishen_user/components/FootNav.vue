            ...
            <div class="flex_col_item_left pos_foot_txt1">
                    ...
                    <ul class="">
                        ...
                        <li class="foot_downbox clear_fix">
                            ...
                            <div class="f_left foot_downbox_cell mar_l40">
                                <el-tooltip class="item" effect="dark" placement="top">
                                    <div slot="content">
                                        <img style="width: 100px;" src="../images/code_0_cn.png" alt='雷神加速器' v-if="this.webParam.region_code == 0 && this.webParam.language == 'zh_CN'">
                                        <img style="width: 100px;" src="../images/code_1_cn.png" alt='雷神加速器' v-if="this.webParam.region_code == 1 && this.webParam.language == 'zh_CN'">
                                        <img style="width: 100px;" src="../images/code_0_en.png" alt='雷神加速器' v-if="this.webParam.region_code == 0 && this.webParam.language == 'en'">
                                        <img style="width: 100px;" src="../images/code_1_en.png" alt='雷神加速器' v-if="this.webParam.region_code == 1 && this.webParam.language == 'en'">
                                    </div>
                                    <div>
                ...
                <div>
                    <ul class="flex_column_around">
                        ...
                        <li>
                            <a class="list_font pos_foot_txt3" @click="goActivity">{{$t("nav.navlist12")}}</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <ul class="flex_column_around">
                        ...
                        <li>
                            <a class="list_font pos_foot_txt3" @click="goHelp">{{$t("nav.navlist14")}}</a>
                        </li>
                        <li>
                            <a class="list_font pos_foot_txt3" @click="goUserServer">{{$t("nav.navlist15")}}</a>
                        </li>
                    </ul>
                </div>
                <div>
                    <ul class="flex_column_around">
                        ...
                        <li>
                            <el-tooltip class="item" effect="dark" placement="left">
                                ...
                                <a class="list_font pos_foot_txt3" href="https://weibo.com/p/1006066443936086?is_hot=1"
                                   target="_blank">
                                    {{$t("nav.navlist18")}}</a>
                            </el-tooltip>
                        </li>
...
<script lang="ts">
    ...
    import webModel from "@/ts/models/AppModel";
    ...
    export default class FootNav extends Vue {
        public webParam = webModel.getInstace();
