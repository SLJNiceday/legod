<template>
    <div class="components_cell">
            ...
            <div class="web_list_box">
                <ul v-show="tabIndex == 0">
                    ...
                    <li class="web_list_cell">
                        <div class="flex_row_start" style="width:80%">
                            ...
                            <p style="width: 80%;" class="safty_font14_huise">{{$t("user.b134")}}</p>
                        </div>
                        <div class="flex_sbe web_binding_box">
                            <div class="edit_cell pos_safty_bind"></div>
                ...
                <ul class="flex_sbe_wrap" style="width: 706px" v-show="tabIndex == 1">
                    <li class="satety_cell">
                        ...
                        <div class="flex_sbe web_binding_box" v-show="!thirdBindState.wechat"  @click="setBindUrlTYype('wechart')">
                            <div class="binding_cell pos_safty_bind"></div>
                            <a href="javascript:void(0)" class="safty_font16_black">{{$t("public.share8")}}</a>
                        </div>
                    ...
                    <li class="satety_cell">
                        ...
                        <div class="flex_sbe web_binding_box" v-show="!thirdBindState.QQ" @click="setBindUrlTYype('qq')">
                            <div class="binding_cell pos_safty_bind"></div>
                            <a href="javascript:void(0)" class="safty_font16_black">{{$t("public.share8")}}</a>
                        </div>
                    ...
                    <li class="satety_cell">
                        ...
                        <div class="flex_sbe web_binding_box" v-show="!thirdBindState.weibo" @click="setBindUrlTYype('weibo')">
                            <div class="binding_cell pos_safty_bind"></div>
                            <a href="javascript:void(0)" class="safty_font16_black">{{$t("public.share8")}}</a>
                        </div>
        ...
        <!-- 绑定手机 -->
        <el-dialog :visible.sync="bindPhoneShow" :title="$t('user.b100')" :close-on-press-escape="false" :close-on-click-modal="false" :show-close="false" @close="onbindPhoneClose" width="30%" append-to-body>
            <div v-loading="isLoading">
                <div class="dialog_form">
                    ...
                    <div class="form_input_box flex_row_between" style="margin-top:15px;">
                            <el-select @change="onSelectCountryCode" v-model="country_code.code"
                                       placeholder="" style="width:40%;height: 100%;border: 1px solid #eee;border-radius: 5px;" >
                                <div slot="prefix"><img :src="country_code.ico" style="margin-top:5px;" class="select_box__img" alt=""> </div>
                                <el-option-group
                        ...
                        <div class="form_input_box" style="width:59%">
...
<script lang="ts">
    ...
    export default class UserSafety extends BindingProxy {
        ...
        public created() {
            ...
            //开发
            // this.qq_url = 'https://graph.qq.com/oauth2.0/show?which=Login&display=pc&response_type=code&client_id=101503698&redirect_uri=http://dev-api1.leigod.com/api/auth/open/qq&state=' + this.webParam.region_code + '_0_' + this.languageType + '_2' + '&scope=get_user_info';
            ...
            //@ts-ignore
            if (window.getThirdBindState == undefined) {
                //@ts-ignore
                window.getThirdBindState = this.getThirdBindState
            }
        }
        /**
         * 打开绑定账号弹窗
        ...
        public modifyEmail() {
            ...
            if(!isNotif && !CheckUtil.checkimgVerificatioCode(this.imgCaptchaCode)) {
                isNotif = true;
        ...
        public setBindUrlTYype (type:string){
            LocalStorageUtil.addthreeBindSource('0')
            let offsetLeft=0
            switch (type) {
                case 'qq':
                    offsetLeft=(document.body.clientWidth-460)/2;
                    window.open(this.qq_url, "leigod_three_login", "height=630, width=460, top=100, left="+offsetLeft+",toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no")
                    break;
                case 'wechart':
                    offsetLeft=(document.body.clientWidth-460)/2
                    window.open(this.wechart_url, "leigod_three_login", "height=630, width=460, top=100, left="+offsetLeft+",toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no")
                    break;
                case 'weibo':
                    offsetLeft=(document.body.clientWidth-630)/2
                    window.open(this.weibo_url, "leigod_three_login", "height=630, width=630, top=100, left="+offsetLeft+",toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no")
                    break;
            }
        }
    }
