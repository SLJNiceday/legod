        ...
        <div class="flex_column_center" style="width: 90%;margin: 0 auto;">
            <div class="web_userinfo_box">
                <div class="form_box flex_column_around" style="margin-right: 80px;">
                    ...
                    <div class="web_form_item">
                        <span class="web_form_title">{{$t("user.b15_0")}}</span>
                        <div class="web_form_iptbox">
                    ...
                    <div class="web_form_item">
                        ...
                        <div class="web_form_iptbox">
                            <provice-com v-if="address.trim()==''" @getlabel="getAdress"></provice-com>
                            <input v-if="address.trim()!=''" v-model="address" @change="onResetInfo" maxlength="25" class="web_form_iptcell" type="text" name="">
                        </div>
                    </div>
                </div>
            ...
            <div class="btn_control">
                <a class="public_btn" style="margin-top: 80px; border-radius:32px;padding: 10px 40px;" @click="saveImage">{{$t("public.share14")}}</a>
...
<script lang="ts">
    ...
    export default class ResetUserinfo extends Vue {
        ...
        public sex: string = '0';//性别 0保密 1帅哥 2美女
