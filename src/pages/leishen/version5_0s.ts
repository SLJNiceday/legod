...
//判断是否跳转移动站点
const mUrl = GlobalConfig.getMobWebBaseUrl() + '/activitys/version5_0s.html';
...
class activityModel extends ActivityProxy {
     ...
     */
    public gotoLogin() {
        JumpWebUtil.webGotoUser(GlobalConfig.getUserBaseUrl(), JumpWebUtil.HTML_NAME_LOGIN,'to=' + GlobalConfig.getWebBaseUrl() +'/version5_0s.html');
    }
