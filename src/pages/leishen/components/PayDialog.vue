<template>
    <div style="height:100%">
        <div class="flex_row_around" v-show="!paySuccessShow" style="height:90%">
            <div class="flex_column_center">
                ...
                <div style="text-align: center;">
                    ...
                    <a class="checkbtn_font paybtn" style="margin-top: 16px;" @click="gotoPrevious">
                        {{$t("user.b59")}}
                    </a>
                </div>
            </div>
        ...
        <div class="flex_column_between" v-show="paySuccessShow" style="height: 90%;">
            ...
            <a class="checkbtn_font paybtn" @click="payDone" style="margin-top:32px;">
                {{$t("user.b60")}}
            </a>
        </div>
    </div>
