...
import { SmsCaptchaRequestModel, SmsCaptchaModel, PhoneFindPwdRequestModel } from '../../ts/netbar/model/userModel';
import { ImgCaptchaRequestModel, ImgCaptchaModel } from '../../ts/netbar/model/RegModel';
...
export default class Forget extends BaseVue {
