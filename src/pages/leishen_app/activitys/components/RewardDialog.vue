    ...
    <div>
        <div class="mui-content orderBox" v-show="!isNeedUserAddress">
            <div style="padding-left: 20px;">
                <span style="line-height: 6vh;display: inline-block;" @click="closereward">
                    <van-icon style="vertical-align: middle;" name="arrow-left" />
                    返回
                </span>
            </div>
            ...
            <div v-show="showNopic" class="leigod_flex" style="flex-direction: column;height: 95vh;">
        ...
        <div id="userPrizeInfo" v-show="isNeedUserAddress">
            <van-nav-bar title="填写兑奖信息" left-text="返回" style="margin-bottom: 6px;margin-top:56px;background: #f2f2f2;"
                         left-arrow
            ...
            <van-cell-group style="background-color:#F2F2F2 !important; margin:8px 16px;">
                ...
                <van-field v-if="!is_miandan" v-model="address" label="地址" style="margin-top:2px;" required placeholder="请输入"/>
                <van-field v-if="is_miandan" v-model="alipay_address" label="支付宝账号" style="margin-top:2px;" required placeholder="请输入"/>
...
<script lang="ts" src="./RewardDialog.ts">
</script>
