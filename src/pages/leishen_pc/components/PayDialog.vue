<template>
    <div class="dialog">
        ...
        <div class="pop" style="top:0.3rem;height:auto;">
            <div class="flex_sbe">
                <span>{{$t("recharge.c6")}}</span>
                <a class="cancel_icon" @click="closePayDialog"></a>
            </div>
            <div class="flex_row_around" v-show="!paySuccessShow">
...
<!--                    <div class="pay_result_box"></div>-->
                    <img src="../images/zhifu_chenggong@2x.png" alt="" width="40">
                    <span style="vertical-align: center;margin-left:0.16rem;font-size: 0.14rem;">{{$t("recharge.c13")}}</span>
                </div>
                <div class="pay_order_info" style="width:60%;font-size: 0.14rem;">
                ...
                <p  style="margin-top:0.1rem;width:60%;">
                    {{$t("recharge.c18")}}
                </p>
                <div class="flex_row_center" style="margin-top:0.1rem;">
                    <img src="../images/wechartCode.png" width="60">
                    <p style="margin-left: .08rem;max-width: 3.2rem;">{{$t('recharge.c47')}}，<br>{{$t('recharge.c48')}}</p>
                </div>
            </div>
        </div>
    </div>
