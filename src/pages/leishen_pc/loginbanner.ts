...
class Loginbanner extends Vue{
    ...
    public async getDownloadUrl() {
        ...
        this.login_banner = jsonConfig.leigod[this.appParam.region_code].login_banner.img_url;
        this.login_banner_link = jsonConfig.leigod[this.appParam.region_code].login_banner.link_url;
    }
